...
const rateProductRepository = require('../../../domain/products/repositories/RateProductRepository');
const productRepository = require('../../../domain/products/repositories/ProductRepository');
const { ProductModel } = require('../../../ports/db/models/ProductModel');
const rateProductService = require('../../../domain/products/services/RateProductService');
const { RateProductModel } = require('../../../ports/db/models/RateProductModel');
const { validateRateProduct, validateParamIdProduct } = require('../../../domain/products/validators/RateProductValidator');
const { getSession } = require('../../../infrastructure/utilities/Utilities');
