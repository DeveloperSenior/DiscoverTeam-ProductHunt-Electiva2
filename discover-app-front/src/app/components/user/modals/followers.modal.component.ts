...
export class FollowersModalComponent extends ComponentBase  implements OnInit,AfterViewInit{
  ...
  displayedColumns: string[] = ['name','contact','bio','createdAt'];
  title!: string;
  constructor(public modalRef: MdbModalRef<FollowersModalComponent>,
  ...
  validateAvatar(follower: any): string {
    return follower.avatar != null ? follower.avatar : this.getImage(follower.userName);
